...
class PostContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    children.add(_RichText(message: post.message ?? ""));
    ...
    if (post.specialPoll != null) {
      children.add(_Poll(specialPoll: post.specialPoll!));
    }
...
class _RichText extends StatefulWidget {
  ...
  const _RichText({Key? key, required this.message}) : super(key: key);
            ...
            children: [
              ...
              if (_expanded.value)
                Material(
                  ...
                  child: _RichText(message: widget.message),
                )
            ],
          ),
        ));
            ...
            child: Container(
              child: Column(
                children: [
                  ...
                  if (_expanded.value) _RichText(message: widget.message)
                ],
              ),
            )));
  }
